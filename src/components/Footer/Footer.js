...
const Footer = () => {
  return (
    <footer className='bg-medium border-t text-sm md:text-lg border-t-light max-h-[10vh] p-4 flex md:justify-between flex-col justify-center items-center md:flex-row gap-2'>
