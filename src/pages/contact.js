  ...
  return (
    <>
      ...
      <main className='flex items-center justify-center my-8'>
        <section className='text-3xl md:text-6xl'>
          <h1 className='font-bold mb-14 text-center'>Contactez-moi</h1>
          <div className='icons flex flex-col justify-center gap-10 items-center md:flex-row text-6xl'>
            <Link id='icon-1' href='mailto:sofianekhenoune.dev@gmail.com'>
              <SiMinutemailer className='hover:scale-110' />
            </Link>
            <Link
              id='icon-2'
